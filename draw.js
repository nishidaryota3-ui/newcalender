...
function drawRainfallGraph(cycleStartTimeMs) {
    ...
    const labelsToDraw = [{ relAngle: 96 }, { relAngle: 288 }];
...
function drawKoyomiEvents(startDate) {
    ...
    if(wafuTextLayer) {
        ...
        tspanOld.setAttribute("transform", `rotate(${-(window.globalRotation||0)}, ${cX}, ${cY})`);
        ...
        tspanNew.setAttribute("transform", `rotate(${-(window.globalRotation||0)}, ${cX}, ${cY})`);
